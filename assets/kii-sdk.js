...
root.KiiEncryptedBucketWithToken = (function(superClass) {
  extend(KiiEncryptedBucketWithToken, superClass);
...
root.KiiBucketWithToken = (function(superClass) {
  extend(KiiBucketWithToken, superClass);
...
root.KiiUser = (function() {
  function KiiUser() {
    ...
    this.pushInstallation = bind(this.pushInstallation, this);
    ...
    this._setLocalPhone = bind(this._setLocalPhone, this);
    this.getPendingPhoneNumber = bind(this.getPendingPhoneNumber, this);
    this._setPhoneNumber = bind(this._setPhoneNumber, this);
    this.getPhoneNumber = bind(this.getPhoneNumber, this);
    this.getPendingEmailAddress = bind(this.getPendingEmailAddress, this);
...
root.KiiACLWithToken = (function(superClass) {
  extend(KiiACLWithToken, superClass);
...
root.KiiGroupWithToken = (function(superClass) {
  extend(KiiGroupWithToken, superClass);
...
root.KiiObjectWithToken = (function(superClass) {
  extend(KiiObjectWithToken, superClass);
...
root.KiiUserWithToken = (function(superClass) {
  extend(KiiUserWithToken, superClass);
...
root.KiiThing = (function() {
  function KiiThing(fields1) {
    ...
    this.refresh = bind(this.refresh, this);
    this.getOnlineStatusModifiedAt = bind(this.getOnlineStatusModifiedAt, this);
...
root.KiiThingWithToken = (function(superClass) {
  extend(KiiThingWithToken, superClass);
...
root.KiiTopicWithToken = (function(superClass) {
  extend(KiiTopicWithToken, superClass);
...
root.KiiPushSubscriptionWithToken = (function(superClass) {
  extend(KiiPushSubscriptionWithToken, superClass);
...
root.KiiThingContext = (function() {
  function KiiThingContext(spec) {
    ...
    this._getToken = bind(this._getToken, this);
    this.pushInstallation = bind(this.pushInstallation, this);
    this.getAuthenticatedThing = bind(this.getAuthenticatedThing, this);
    this.listTopics = bind(this.listTopics, this);
    this.topicWithName = bind(this.topicWithName, this);
    this._token = spec.token;
...
root.KiiPushInstallation = (function() {
  function KiiPushInstallation(user) {
    this._setAuthToken = bind(this._setAuthToken, this);
    this.uninstallByInstallationID = bind(this.uninstallByInstallationID, this);
    this.uninstall = bind(this.uninstall, this);
    this._getMqttEndpoint = bind(this._getMqttEndpoint, this);
    this.getMqttEndpoint = bind(this.getMqttEndpoint, this);
    this._install = bind(this._install, this);
    this.installMqtt = bind(this.installMqtt, this);
    this.installGcm = bind(this.installGcm, this);
    this._user = user;
  }
...
root.KiiPushInstallationWithToken = (function(superClass) {
  extend(KiiPushInstallationWithToken, superClass);
