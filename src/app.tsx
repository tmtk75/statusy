...
class Connect extends React.Component<AppProps, {github_token: string}> {
  ...
  render() {
    ...
    return (
      <div>
        <div className="section">
          <IconGroup /><span className="section-text">Link with GitHub</span>
        </div>
        <TextField
        ...
        <div style={{display:"flex", justifyContent:"center"}}>
          <FlatButton
            ...
            onClick={_ => dispatch(link({github_token: this.state.github_token}))}
            />
        </div>
        <div>
        {
          ...
          <div>
            Please link with your GitHub account to join groups corresponding to your github organizations
            with your token generated by GitHub <a href="#" onClick={
              () => remote.shell.openExternal('https://github.com/settings/tokens')
            }>here</a>. The token doesn't need any scopes and is never stored in the server.
          </div>
        }
        {
          this.state.github_token ? null :
          <div>You can ask someone else to invite you if you don't use GitHub token.</div>
        }
        </div>
      </div>
    )
